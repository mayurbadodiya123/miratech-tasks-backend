export const message = {
  ...
  employee: {
    ...
    getEmployeeSuccess: 'Employee details found',
    deleteEmployeeSuccess: 'Employee deleted succussfully',
    EmployeeListSuccess: 'Record found',
  },
  position: {
    addPositionSuccess: 'Position added successfully',
    updatePositionSuccess: 'Position updated successfully',
    getPositionSuccess: 'Position details found',
    deletePositionSuccess: 'Position deleted succussfully',
    PositionListSuccess: 'Record found',
    teamList: 'Team list found successfully',
  },
  team: {
    addTeamSuccess: 'Team added successfully',
    updateTeamSuccess: 'Team updated successfully',
    getTeamSuccess: 'Team details found',
    deleteTeamSuccess: 'Team deleted succussfully',
    TeamListSuccess: 'Record found',
  },
};
